 ...
 */
declare function mergeProps<TDefaultProps extends PlainObject<any>, TProps extends PlainObject<any>>(defaultProps: TDefaultProps, props: TProps): TProps & Required<Pick<TProps, keyof TDefaultProps & string>> extends infer T ? { [KeyType in keyof T]: (TProps & Required<Pick<TProps, keyof TDefaultProps & string>>)[KeyType]; } : never;
/**
